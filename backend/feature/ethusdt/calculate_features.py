#!/usr/bin/env python3
"""
ethUSDT Feature Calculator
Calculates technical indicators for ETHUSDT 1h data:
- Log returns
...
POSSIBLE_DATA_PATHS = [
    "../../data/ethusdt/1h_eth.parquet",  # From feature/ethusdt directory
    "data/ethusdt/1h_eth.parquet",        # From backend directory
]
# Get the directory where this script is located for output
SCRIPT_DIR = Path(__file__).parent
OUTPUT_FILE = SCRIPT_DIR / "ethusdt_features.parquet"
...
def main():
    print("=== ETHUSDT Feature Calculator ===")
