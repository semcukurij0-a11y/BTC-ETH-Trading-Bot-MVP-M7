#!/usr/bin/env python3
"""
Incremental Bybit ETHUSDT fetcher (1h OHLCV + mark + index, funding)
- Saves 2 parquet files:
    1) 1h_eth_market.parquet -> OHLCV + mark + index price
...
OUT_FILE = os.path.join(SCRIPT_DIR, "1h_eth.parquet")
