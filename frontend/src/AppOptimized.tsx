...
function AppOptimized() {
  ...
  const renderActivePanel = () => {
    ...
    switch (activeTab) {
      ...
      case 'positions':
        return <PositionsPanel service={service} data={positions} />;
      case 'orders':
        return <OrdersPanel service={service} data={orders} />;
      case 'signals':
        return <SignalsPanel service={service} data={signals} />;
      case 'risk':
        return <RiskPanel service={service} data={{ riskData, systemStatus }} />;
      case 'margin':
        return <MarginRatioPanel service={service} data={marginData} />;
      case 'latency':
        return <APILatencyPanel service={service} data={latencyData} />;
      case 'funding':
        return <FundingPanel service={service} data={fundingData} />;
      case 'controls':
        return <ControlsPanel service={service} data={systemStatus} />;
      case 'alerts':
        return <EnhancedAlertsPanel service={service} data={alerts} />;
      case 'backtest':
        return <BacktestPanel service={service} data={backtestData} />;
      case 'realtime':
      ...
      default:
        return <TradingDashboard service={service} data={{ systemStatus }} />;
    }
  };
